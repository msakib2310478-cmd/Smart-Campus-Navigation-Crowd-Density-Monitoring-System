  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-cyan-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-2xl p-8 w-full max-w-md">
        <h2 className="text-3xl font-bold text-center mb-2 text-teal-700">Create Account</h2>
        <p className="text-center text-gray-600 mb-6">Join Campus Navigation System</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Email <span className="text-gray-400 text-xs">(optional if Student ID provided)</span>
            </label>
            <input
              type="email"
              value={email}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Student ID <span className="text-gray-400 text-xs">(optional if Email provided)</span>
            </label>
            <input
              type="text"
              value={studentId}
            ...
            />
            <p className="text-xs text-gray-500 mt-1">9-11 digits (provide either Email or Student ID)</p>
          </div>
