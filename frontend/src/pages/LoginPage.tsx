...
export const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await authAPI.login(email, studentId, password);
      login(response.data);
      navigate('/dashboard');
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-cyan-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-2xl p-8 w-full max-w-md">
        <h2 className="text-3xl font-bold text-center mb-2 text-teal-700">Welcome Back</h2>
        <p className="text-center text-gray-600 mb-6">Login to Campus Navigation</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">Use either email or student ID</p>
          </div>
